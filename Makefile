...
17.09.0.ce-centos7:
	$(DOCKER) build --build-arg RUNTIME_VERSION="$(RUNTIME_VERSION)-1.17.09.0" \
...
17.06.2.ce-centos7:
	$(DOCKER) build --build-arg RUNTIME_VERSION="$(RUNTIME_VERSION)-1.17.06.2" \
...
17.06.1.ce-centos7:
	$(DOCKER) build --build-arg RUNTIME_VERSION="$(RUNTIME_VERSION)-1.17.06.1" \
...
17.03.2.ce-centos7:
	$(DOCKER) build --build-arg RUNTIME_VERSION="$(RUNTIME_VERSION)-1.17.03.2" \
